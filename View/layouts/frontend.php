    ...
    <header class="header">
        <div class="container header-inner">
            ...
            <div class="header-actions">
                ...
                <a href="/wf/foodsave/index.php?action=profile" class="btn btn-small btn-secondary">Profil</a>
                <a href="/wf/foodsave/index.php?action=logout" class="btn btn-small btn-primary">Deconnexion</a>
            </div>
        </div>
    </header>
