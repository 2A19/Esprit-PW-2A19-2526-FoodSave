...
class DechetController {
    ...
    public function stats(): void {
        ...
        $byRaison   = $this->model->getStatsByRaison();
        $byCategorie= $this->model->getStatsByCategorie();
        $byMonth    = $this->model->getStatsByMonth();
        $byType     = $this->model->getStatsByType();
        require_once __DIR__ . '/../View/Back/dechet/stats.php';
    }

    public function index(): void {
        $dechets = $this->model->findAll();
        $stats   = $this->model->getStats();
        require_once __DIR__ . '/../View/Front/dechet/index.php';
    }

    public function search(): void {
        $q       = trim($_GET['q'] ?? '');
        $dechets = $q !== '' ? $this->model->search($q) : $this->model->findAll();
        $stats   = $this->model->getStats();
        require_once __DIR__ . '/../View/Front/dechet/index.php';
    }

    public function create(): void {
        require_once __DIR__ . '/../View/Front/dechet/create.php';
    }

    public function store(): void {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header('Location: index.php?action=dechet_create');
            exit;
        }
        ...
        header('Location: index.php?action=dechet_index');
        exit;
    }
    ...
    public function edit(): void {
        ...
        $dechet = $d;
        require_once __DIR__ . '/../View/Front/dechet/edit.php';
    }
    ...
    public function update(): void {
        ...
        if (!empty($errors)) {
            $_SESSION['errors'] = $errors;
            $_SESSION['old']    = $_POST;
            header('Location: index.php?action=dechet_edit&id=' . $d->getId());
            exit;
        }
