...
class User {
    ...
    // Constructor
    public function __construct(?int $id = null, ?string $prenom = null, ?string $nom = null, ?string $email = null, ?string $password = null, ?string $telephone = null, ?DateTime $date_naissance = null, ?string $profile_photo = null, ?string $role = null, ?string $statut = null, ?DateTime $date_inscription = null) {
        $this->id = $id;
        $this->prenom = $prenom;
        $this->nom = $nom;
        $this->email = $email;
