...
<div class="admin-container">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="admin.php?action=adminAvis" class="active"><i class="fas fa-star"></i> <span>Avis</span></a></li>
    ...
    <div class="main-content">
        ...
        <nav class="navbar">
            <div class="nav-container">
                ...
                <div class="nav-menu">
                    ...
                    <a href="admin.php?action=adminAvis" class="nav-link active">Avis</a>
                </div>
        ...
        <div style="margin-bottom: 20px;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                ...
                <a href="admin.php?action=clearAllNotifications" 
            ...
            if(isset($_SESSION['notifications']) && !empty($_SESSION['notifications'])) {
                foreach($_SESSION['notifications'] as $key => $notif) {
                    ...
                    echo '</div>';
                    echo '<div>';
                    echo '<a href="admin.php?action=clearNotification&key=' . $key . '" class="notification-close" title="Supprimer">✖</a>';
                    echo '</div>';
                    echo '</div>';
                }
            }
                    ...
                    <tbody>
                        ...
                        <tr data-statut="<?php echo $a['statut']; ?>">
                            ...
                            <td class="action-btns">
                                <a href="admin.php?action=editAvisForm&id=<?php echo $a['id']; ?>" class="btn-edit">
                                    <i class="fas fa-edit"></i> Modifier
                                </a>
                                <?php if($a['statut'] == 'en attente'): ?>
                                    <a href="admin.php?action=approveAvis&id=<?php echo $a['id']; ?>" class="btn-validate" onclick="return confirm('Approuver cet avis ?')">
                                        <i class="fas fa-check"></i> Approuver
                                    </a>
                                <?php endif; ?>
                                <a href="admin.php?action=deleteAvis&id=<?php echo $a['id']; ?>" class="btn-delete" onclick="return confirm('Supprimer cet avis ?')">
...
<script>
    ...
    function checkNotifications() {
        fetch('admin.php?action=checkNotifications&last=' + lastTimestamp)
