...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .current-image{max-width:150px;border-radius:12px;margin-right:15px}
...
<div class="form-container">
    <div class="form-card">
        ...
        <form id="editArticleForm" action="admin.php?action=editArticle" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Résumé</label>
                <textarea id="resume" name="resume" rows="2" placeholder="Court résumé de l'article..."><?php echo htmlspecialchars($article['resume']); ?></textarea>
            </div>
            
            <div class="form-group">
                <label class="required">Contenu</label>
                <textarea id="contenu" name="contenu" rows="8" placeholder="Contenu complet de l'article..."><?php echo htmlspecialchars($article['contenu']); ?></textarea>
            </div>
            
           <!-- SECTION IMAGE AVEC OPTION DE SUPPRESSION -->
<div class="form-group">
    <label>Image actuelle</label>
    <?php if($article['image']): ?>
        <div class="image-delete-row">
            <img src="./assets/uploads/<?php echo $article['image']; ?>" class="current-image" alt="Image actuelle">
            <label class="delete-checkbox">
                <input type="checkbox" name="supprimer_image" value="1">
                <i class="fas fa-trash-alt"></i> Supprimer cette image
            </label>
        </div>
        <small style="color: #fbbf24;">📌 Pour remplacer l'image, sélectionnez une nouvelle image (la suppression sera ignorée).</small>
    <?php else: ?>
...
<div class="form-group">
    <label>Nouvelle image (pour remplacer l'actuelle)</label>
...
<script src="/public/js/modifier_article.js"></script>
