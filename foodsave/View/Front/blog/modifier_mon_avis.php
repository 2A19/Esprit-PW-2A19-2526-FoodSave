...
<head>
    ...
    <title>FoodSave - <?php echo $t('edit_review'); ?></title>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .info-note{background:rgba(74,222,128,0.08);padding:12px;border-radius:12px;margin-bottom:20px;text-align:center;border:1px solid rgba(74,222,128,0.15)}
        ...
        .btn-save{padding:12px 24px;background:linear-gradient(135deg,#fbbf24,#e0a800);border:none;border-radius:50px;color:#333;font-size:14px;font-weight:700;cursor:pointer;transition:all 0.2s;width:100%}
...
<div class="language-selector">
    <a href="?lang=fr&action=editUserAvis&id=<?php echo $avis['id']; ?>" class="<?php echo $lang == 'fr' ? 'active' : ''; ?>">🇫🇷 FR</a>
    <span>|</span>
    <a href="?lang=en&action=editUserAvis&id=<?php echo $avis['id']; ?>" class="<?php echo $lang == 'en' ? 'active' : ''; ?>">🇬🇧 EN</a>
</div>
...
<div class="form-container">
    ...
    <div class="form-card">
        <div class="form-title">✏️ <?php echo $t('edit_review'); ?></div>
        <div class="form-sub"><?php echo $t('save_changes'); ?></div>
        ...
        <form id="editAvisForm" action="index.php?action=editUserAvisSubmit" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea id="contenu" name="contenu" rows="5" placeholder="<?php echo $t('share_experience'); ?>"><?php echo htmlspecialchars($avis['contenu']); ?></textarea>
                <small><?php echo $t('min_5_chars'); ?></small>
            </div>
            
            <button type="submit" class="btn-save">💾 <?php echo $t('save_changes'); ?></button>
        </form>
    </div>
</div>

<script src="/public/js/validationAvis.js"></script>
<script src="/public/js/modifier_avis.js"></script>
