...
<nav>
  <div class="nav-logo">
    <img src="assets/images/logo.png" alt="FoodSave" style="height:40px;width:auto;object-fit:contain;" />
  </div>
  <ul class="nav-links">
  ...
  <div class="nav-cta">
    <button class="btn-ghost" onclick="window.location.href='index.php?action=login'">Se connecter</button>
    <button class="btn-solid" onclick="window.location.href='index.php?action=dashboard_spa'">Espace client →</button>
  </div>
</nav>
...
<section class="hero" id="home">
  ...
  <div class="hero-content">
    ...
    <div class="hero-actions">
      <button class="btn-hero-primary" onclick="window.location.href='index.php?action=dashboard_spa'">
        Accéder
        <span>→</span>
      </button>
  ...
  <div class="footer-grid">
    <div>
      <div class="footer-logo">
        <img src="assets/images/logo.png" alt="FoodSave" style="height:38px;width:auto;object-fit:contain;filter:brightness(1.1);" />
      </div>
