...
<aside class="sidebar">
  <div class="sidebar-logo">
    ...
    <div>
      ...
      <span class="sidebar-logo-sub">Zéro gaspillage</span>
    </div>
  </div>
  ...
  <nav class="sidebar-nav">
    ...
    <a class="nav-item" data-page="list" onclick="navigate('list')">
      <span class="icon">🗑️</span> Déchets
    </a>
    <a class="nav-item" data-page="add" onclick="navigate('add')">
      <span class="icon">➕</span> Nouveau déchet
    </a>
    ...
    <a class="nav-item" data-page="collectes" onclick="navigate('collectes')">
      <span class="icon">🚛</span> Collectes
    </a>
...
<div class="main">
  ...
  <div id="page-list" class="page">
    ...
    <div class="card">
      <div class="card-header">
        <h2>🗑️ Liste des déchets alimentaires</h2>
        <div style="display:flex;gap:12px;align-items:center;">
          <div class="search-bar">
            <span class="search-icon">🔍</span>
            <input type="text" id="search-input" placeholder="Rechercher..." />
          </div>
          <button class="btn btn-primary" onclick="navigate('add')">➕ Ajouter</button>
        </div>
      </div>
  ...
  <div id="page-categories" class="page">
    ...
    <div class="card" style="margin-bottom:28px;">
      <div class="card-header">
        ...
        <button class="btn btn-outline btn-sm" onclick="toggleCatForm()">▾ Formulaire</button>
      </div>
  ...
  <div id="page-collectes" class="page">
    ...
    <div class="card" style="margin-bottom:28px;">
      <div class="card-header">
        ...
        <button class="btn btn-outline btn-sm" onclick="toggleColForm()">▾ Formulaire</button>
      </div>
