...
switch ($section) {
    ...
    case 'profile':
        header('Location: foodsave/index.php?action=profile');
        exit;
    
    case 'forum':
    default:
        header('Location: forum/index.php?action=' . urlencode($action ?: 'list'));
        exit;
    ...
    case 'admin':
        ...
        header('Location: foodsave/admin.php?action=' . urlencode($action ?: 'dashboard'));
        exit;
    ...
    case 'admin-forum':
        ...
        header('Location: forum/admin.php?action=' . urlencode($action ?: 'dashboard'));
        exit;
...
header('Location: forum/index.php?action=list');
exit;
?>
