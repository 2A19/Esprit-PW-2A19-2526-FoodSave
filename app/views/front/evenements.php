<?php
// ============================================================
//  app/views/front/evenements.php — Liste complete
// ============================================================
...
if ($categorie !== '') {
    $filtered = [];
    foreach ($rows as $r) { if ($r['categorie'] === $categorie) $filtered[] = $r; }
    $rows = $filtered;
}

foreach ($rows as &$r) { $r['nb_p'] = $model->countParticipants($r['id']); }
unset($r);
  ...
  <div class="f-container">
    ...
    <div class="filter-bar" style="margin-bottom:24px">
      <form method="GET" style="display:flex;gap:10px;flex-wrap:wrap;flex:1">
        <input class="s-input" type="text" name="search" placeholder="🔍 Rechercher..."
