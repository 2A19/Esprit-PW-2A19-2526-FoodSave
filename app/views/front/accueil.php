<?php
// ============================================================
//  app/views/front/accueil.php — FrontOffice Accueil
//  Acces : localhost/foodsave2/app/views/front/accueil.php
// ============================================================
require_once __DIR__ . '/../../../config/database.php';
require_once __DIR__ . '/../../models/EvenementModel.php';

$model      = new EvenementModel();
$evenements = $model->findUpcoming(6);
foreach ($evenements as &$ev) {
    $ev['nb_p'] = $model->countParticipants($ev['id']);
}
unset($ev);
...
<nav class="front-nav">
  <div class="fn-inner">
    ...
    <div class="fn-links">
      ...
      <a href="evenements.php" class="<?= $currentUrl==='evenements.php'?'on':'' ?>">Evenements</a>
