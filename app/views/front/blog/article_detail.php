...
// ===== URL NGORK POUR LE PARTAGE SOCIAL (À MODIFIER SI NGORK CHANGE) =====
$ngrok_url = 'https://unenvied-lurk-uncross.ngrok-free.dev';
$base_url = $ngrok_url . '/FoodSave/public/';
$article_full_url = $base_url . 'index.php?action=detail&id=' . $article['id'];

// ===== EXTRAIRE L'ID YOUTUBE POUR LA VIDÉO =====
...
<head>
    ...
    <!-- ===== BALISES OPEN GRAPH POUR LE PARTAGE SOCIAL (AVEC URL NGORK) ===== -->
    ...
    <meta property="og:image" content="<?php echo $base_url . 'uploads/' . $article['image']; ?>" />
    <?php else: ?>
    <meta property="og:image" content="<?php echo $base_url . 'assets/images/logo_foodsave.png'; ?>" />
    <?php endif; ?>
    ...
    <?php if(!empty($article['image'])): ?>
    <meta name="twitter:image" content="<?php echo $base_url . 'uploads/' . $article['image']; ?>" />
    <?php endif; ?>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .article-image{width:100%;border-radius:20px;margin-bottom:2rem}
...
<div class="language-selector">
    <a href="?lang=fr&action=detail&id=<?php echo $article['id']; ?>" class="<?php echo $lang == 'fr' ? 'active' : ''; ?>">🇫🇷 FR</a>
    <span>|</span>
    <a href="?lang=en&action=detail&id=<?php echo $article['id']; ?>" class="<?php echo $lang == 'en' ? 'active' : ''; ?>">🇬🇧 EN</a>
</div>
...
<section class="article-section">
    ...
    <!-- ===== BOUTONS DE PARTAGE SOCIAL AVEC URL NGORK ===== -->
    ...
    <?php if($article['image']): ?>
        <img src="/FoodSave/public/uploads/<?php echo $article['image']; ?>" class="article-image">
    <?php endif; ?>
