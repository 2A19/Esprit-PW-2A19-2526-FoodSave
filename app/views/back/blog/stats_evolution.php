...
<div class="admin-container">
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="index.php?action=statsEvolution" class="active"><i class="fas fa-chart-line"></i> <span>Statistiques</span></a></li>
        ...
        <nav class="navbar">
            <div class="nav-container">
                ...
                <div class="nav-menu">
                    ...
                    <a href="index.php?action=statsEvolution" class="nav-link active">Statistiques</a>
                </div>
